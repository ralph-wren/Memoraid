...
- **设置面板优化**：重构了设置面板的保存机制，彻底解决了输入 API Key 和 Token 时的卡顿问题，输入体验更加丝滑。
- **文章生成效果提升**：优化了通用及各平台提示词，AI 生成的文章更加连贯自然，移除了生硬的转折词和刻意的分段，输出内容更具“人味”。
- **版本控制机制**：引入了提示词版本控制，确保所有用户都能实时获取最新的提示词优化方案。
